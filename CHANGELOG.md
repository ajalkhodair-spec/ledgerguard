...
## 2.0.0-poc - 2026-08-29

### Added

- LedgerGuard V2 receipt identity, domain separation, expected-cohort reconciliation, witness confirmation, and optimistic rollout concurrency controls.
- V1 to V2 compatibility specification, storage-layout evidence, and migration tests.
- Persistent HTTP/SQLite comparison with matched common governance semantics.
...
- Physical-device, HSM, secure-element, production PKI, production WAN, formal verification, and Mythril evidence remain not run.
- Fleet execution is software-emulated.
- Network profiles use application-level pacing against a local IPFS gateway.
- Accountability fleet/batch scaling is analytical and uses locally measured gas medians plus compiler storage layouts.

## 1.0.0-poc

- Initial local LedgerGuard V1 proof of concept and result-generation workflow.
